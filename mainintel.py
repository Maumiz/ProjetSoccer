...
list_key_player1=['w', 'x', 'f', 'z', 's', 'q', 'd', 'e', 'r', 't']
list_strat_player1=[AllerVersCages(), Immobile(), AllerVersBalle(), Haut(), Bas(), Gauche(), Droit(), AllerTirerBas(), AllerTirerHaut(), AllerTirerCages()]
